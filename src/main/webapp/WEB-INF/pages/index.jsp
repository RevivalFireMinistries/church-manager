...
<head>
	...
	<title data-ng-bind="pageTitle()">eSavvy - Intelligent Church Management</title>
	<!-- Google fonts -->
	...
	<!-- Clip-Two Theme -->
	<link rel="stylesheet" data-ng-href="static/assets/css/themes/{{ app.layout.theme }}.css" />
</head>
...
<!-- UI Bootstrap -->
<script src="static/vendor/bootstrap/js/ui-bootstrap-tpls-0.12.1.min.js"></script>
<!-- Loading Bar -->
