...
<html lang="en">
	...
	<!-- start: HEAD -->
	<head>
		<title>eSavvy- Intelligent Church!</title>
		<!-- start: META -->
	...
	<body ng-app="eSavvyApp">
							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Service Reports </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> SMS </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Tithes </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Follow Up </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Downloads </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Bulletins </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">
							<img src="static/assets/images/logo.png" alt="eSavvy"/>
						</a>
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
											...
											<ul>
													...
													<a href="javascript:;" class="unread">
														<div class="clearfix">
															<div class="thread-image">
																<img src="static//assets/images/avatar-2.jpg" alt="">
															</div>
												...
												<li>
													<a href="javascript:;" class="unread">
														<div class="clearfix">
															<div class="thread-image">
																<img src="static/assets/images/avatar-3.jpg" alt="">
															</div>
															<div class="thread-content">
												...
												<li>
													<a href="javascript:;">
														<div class="clearfix">
															<div class="thread-image">
																<img src="static/assets/images/avatar-5.jpg" alt="">
															</div>
															<div class="thread-content">
										...
										<div class="drop-down-wrapper ps-container">
											<div class="list-group no-margin">
												<a class="media list-group-item" href="">
													<img class="img-circle" alt="..." src="static/assets/images/avatar-1.jpg">
							...
							<li class="dropdown">
								<a href class="dropdown-toggle" data-toggle="dropdown">
									<i class="ti-world"></i> Stellenbosch, ZA
								</a>
								...
								<div class="users-list">
									<div class="sidebar-content perfect-scrollbar">
										...
										<ul class="media-list">
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<img alt="..." src="static/assets/images/avatar-2.jpg" class="media-object">
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<i class="fa fa-circle status-online"></i>
													<img alt="..." src="static/assets/images/avatar-3.jpg" class="media-object">
													<div class="media-body">
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<i class="fa fa-circle status-online"></i>
													<img alt="..." src="static/assets/images/avatar-4.jpg" class="media-object">
													<div class="media-body">
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<i class="fa fa-circle status-online"></i>
													<img alt="..." src="static/assets/images/avatar-5.jpg" class="media-object">
													<div class="media-body">
										...
										<ul class="media-list">
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<img alt="..." src="static/assets/images/avatar-6.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Nicole Bell</h4>
														<span> Content Designer </span>
													</div>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<img alt="..." src="static/assets/images/avatar-7.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Steven Thompson</h4>
														<span> Visual Designer </span>
													</div>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<img alt="..." src="static/assets/images/avatar-8.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Ella Patterson</h4>
														<span> Web Editor </span>
													</div>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<img alt="..." src="static/assets/images/avatar-9.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Kenneth Ross</h4>
														<span> Senior Designer </span>
													</div>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<img alt="..." src="static/assets/images/avatar-10.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Ella Patterson</h4>
														<span> Web Editor </span>
													</div>
		...
		<script src="static/vendor/maskedinput/jquery.maskedinput.min.js"></script>
		...
		<script src="static/vendor/selectFx/classie.js"></script>
		<script src="static/vendor/selectFx/selectFx.js"></script>
