 ...
 */
app.controller('EventsCtrl', function ($scope, $state,SweetAlert,Events,$localStorage,toaster) {


    $scope.event = {};
    $scope.event.assemblyId = $localStorage.user.assemblyId;
    $scope.comment = {};
    ...
    $scope.form = {
        ...
        submit: function (form) {
            ...
            if (form.$invalid) {
                ...
                var eventdate = moment($scope.eventDateString).format('YYYY-MM-DD');
